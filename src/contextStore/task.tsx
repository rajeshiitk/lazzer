...
const [tasks, setTasks] = useState<task[]>([]); //an array of task objects
 ...
 async function  handleAddtask(task: task) {
  ...
  async function handleDeletetask(taskId: string) {
    ...
    return (
        // @ts-ignore
        <tasksContext.Provider value={{ tasks,getTasks, handleAddtask, toggleTaskAsCompleted, handleDeletetask, handleUpdateTask,taskData, setTaskData,loading,setLoading}}>
            {children}
