...
function AddTask() {
  ...
  React.useEffect(() => {
    if (taskData.title.length > 0 && taskData.description.length > 0) {
          ...
          <div className="relative   md:px-8  shadow-sm sm:rounded-xl">
            <form className="w-full">
              ...
              <button
                ...
                className={`
              ${
                buttonDisabled ? "bg-gray-400" : "bg-gray-600 hover:bg-gray-700"
              } w-full bg-gray-600 text-white p-3 rounded-md`}
              >
